...
(function () {
  ...
  function init() {
    ...
    buildModal();
    console.log('[AFK-dex] hooks OK — 冒險地圖右側怪物/掉落查詢已啟用(' + INDEX.length + ' 隻怪)。');
  }
  ...
  var SPECIAL_BLOCKS = [
    ...
    { id: 'blessscroll', title: '✦ 賦予祝福卷軸（象牙塔碧恩製作）', keys: ['賦予祝福', '祝福卷軸'], lines: [
      '武器版：對武器施法的卷軸×500＋席琳結晶×5＋500萬金幣；使用成功率 30%。',
      '盔甲版：對盔甲施法的卷軸×500＋席琳結晶×5＋500萬金幣；使用成功率 30%。',
      '飾品版：對飾品施法的卷軸×20＋席琳結晶×10＋1000萬金幣；使用成功率 40%。',
      '製作卷軸本身必定成功；使用時失敗只消耗卷軸，裝備不消失並保留強化、屬性與其他詞綴。'
    ] },

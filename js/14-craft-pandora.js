...
const CRAFT_RECIPES = {
    ...
    npc_kororanz: [
        ...
        { result: 'wpn_gaia_rage', req: [{ id: 'mat_rasta_codex', cnt: 1 }, { id: 'wpn_xbow_abyss', cnt: 1 }, { id: 'mat_blackmithril_plate', cnt: 10 }, { id: 'mat_black_powder', cnt: 50 }, { id: 'mat_holy_relic', cnt: 100 }, { id: 'mat_black_blood', cnt: 50 }] },
        { result: 'wpn_hyperion_despair', req: [{ id: 'mat_rasta_codex', cnt: 1 }, { id: 'wpn_qigu_killing_intent', cnt: 1 }, { id: 'mat_blackmithril_plate', cnt: 10 }, { id: 'mat_black_powder', cnt: 50 }, { id: 'mat_holy_relic', cnt: 100 }, { id: 'mat_black_blood', cnt: 50 }] },
        { result: 'wpn_cronos_fear', req: [{ id: 'mat_rasta_codex', cnt: 1 }, { id: 'wpn_chain_exterminator', cnt: 1 }, { id: 'mat_blackmithril_plate', cnt: 10 }, { id: 'mat_black_powder', cnt: 50 }, { id: 'mat_holy_relic', cnt: 100 }, { id: 'mat_black_blood', cnt: 50 }] },
        { result: 'wpn_titan_rage', req: [{ id: 'mat_rasta_codex', cnt: 1 }, { id: 'wpn_ancient_axe', cnt: 1 }, { id: 'mat_blackmithril_plate', cnt: 10 }, { id: 'mat_black_powder', cnt: 50 }, { id: 'mat_holy_relic', cnt: 100 }, { id: 'mat_black_blood', cnt: 50 }] }
    ],
...
const GOD_WEAPON_CRAFT_RECIPES = [
    ...
    { result: 'god_elf_obsession', src: 'wpn_gaia_rage', srcName: '大地女神的激怒' },
    { result: 'god_mage_eva', src: 'wpn_holycrystal_wand', srcName: '聖晶魔杖' },
    { result: 'god_dark_dantes', sources: [{ id: 'wpn_redshadow_dual', n: '紅影雙刀' }, { id: 'wpn_beastking_claw', n: '獸王鋼爪' }] },
    { result: 'god_illusion_theia', src: 'wpn_hyperion_despair', srcName: '海柏利昂的絕望' },
    { result: 'god_dragon_aurakia', src: 'wpn_cronos_fear', srcName: '克洛諾斯的恐怖' },
    { result: 'god_warrior_fear', src: 'wpn_titan_rage', srcName: '泰坦之怒' }
];

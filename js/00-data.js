...
const DB = {
        ...
        "wpn_powerless_baless": { n: "失去魔力的巴列斯魔杖", type: "wpn", dmgS: 1, dmgL: 1, hit: 0, dmgBonus: 0, spd: 1.0, req: "all", safe: 0, p: 0, gachaWeight: 0, noEnhance: true, d: "魔力早已枯竭的古老魔杖，杖芯卻仍隱隱悸動。攜帶它並使用『靈魂之球』，或許能喚回沉睡的力量……（封印狀態無法強化；使用靈魂之球解封後成品為 +0。可販售，售價 0）" },   // 🔧 巴列斯任務武器；noEnhance＝封印狀態固定 +0
        ...
        // ===== 🏛️ 長老之室傳說製作武器（保留客製素質並整合上游新增武器） =====
        "wpn_emperor_blade":   { n: "真．冥皇執行劍", type: "wpn", w2h: true, legend: true, dmgS: 35, dmgL: 44, hit: 12, dmgBonus: 20, spd: 1, req: "royal,knight,dragon", safe: 6, p: 500000, gachaWeight: 0, eff: "cleave", ignHardSkin: true, str: 2, skillHit: 7, stunHitBonus: 35, meleeCrit: 1, enDmgExtra: 2, enMeleeCrit: 1, spellProc: { skn: "審判衝擊", dice: [8, 12], ele: "none", meleeScale: true }, procRateBase: 1, procRatePerEn: 1, d: "雙手劍。35/44，STR+2、近傷+20、近命中+12、技術命中+7、近距離爆擊+1%；發動審判衝擊；每強化原始傷害+1、武器專屬額外傷害+2（合計+3），近爆擊與魔法發動率+1%，王族、騎士、龍騎士可用，不會損壞。" },
        "wpn_windblade_dagger":{ n: "風刃短劍", type: "wpn", legend: true, dmgS: 28, dmgL: 19, hit: 13, dmgBonus: 10, spd: 0.6, req: "royal,elf", safe: 6, p: 500000, gachaWeight: 0, ignHardSkin: true, mhp: 100, vampPct: 0.1, enDmgExtra: 2, enMeleeCrit: 1, spellProc: { skn: "風之力", dice: [8, 12], ele: "wind", meleeScale: true }, procRateBase: 1, procRatePerEn: 1, d: "單手短劍。28/19，近傷+10、近命中+13、HP+100、攻擊時吸取HP；發動風之力；每強化原始傷害+1、武器專屬額外傷害+2（合計+3），近爆擊與魔法發動率+1%，王族、妖精可用，不會損壞。" },
        "wpn_redshadow_dual":  { n: "紅影雙刀", type: "wpn", w2h: true, legend: true, dmgS: 32, dmgL: 22, hit: 10, dmgBonus: 12, spd: 0.8, req: "dark", safe: 6, p: 500000, gachaWeight: 0, eff: "combo", comboRate: 25, ignHardSkin: true, str: 1, spiritHit: 5, enDmgExtra: 2, skillHitPerEn: 1, spellProc: { skn: "迅捷斬擊", dice: [8, 12], ele: "none", meleeScale: true }, procRateBase: 1, procRatePerEn: 1, d: "黑暗妖精專屬雙刀。32/22，STR+1、近傷+12、近命中+10、精靈命中+5；發動迅捷斬擊；每強化原始傷害+1、武器專屬額外傷害+2（合計+3），破壞命中與魔法發動率+1%，不會損壞。" },
        "wpn_rond_dual":       { n: "倫得雙刀", type: "wpn", w2h: true, dmgS: 18, dmgL: 8, hit: 7, dmgBonus: 2, spd: 0.8, req: "dark", safe: 6, p: 56000, gachaWeight: 5, eff: "combo", comboRate: 33, ignHardSkin: true, procSkill: "sk_revenge_spike", procRateBase: 5, procRatePerEn: 1, d: "倫得一族代代相傳的雙刃，刃身封著大地的怨念，斬擊時激起復仇的尖石。" },
        "wpn_beastking_claw":  { n: "獸王鋼爪", type: "wpn", w2h: true, legend: true, dmgS: 25, dmgL: 20, hit: 0, dmgBonus: 10, spd: 0.9, req: "dark", safe: 6, p: 500000, gachaWeight: 0, eff: "combo", comboRate: 33, ignHardSkin: true, dex: 2, enDmgExtra: 2, skillHitPerEn: 1, spellProc: { skn: "獸王裂擊", dice: [8, 12], ele: "none", meleeScale: true }, procRateBase: 1, procRatePerEn: 1, d: "黑暗妖精專屬鋼爪。25/20，DEX+2、近傷+10；發動獸王裂擊；每強化原始傷害+1、武器專屬額外傷害+2（合計+3），破壞命中與魔法發動率+1%，保留鋼爪爆擊特性，不會損壞。" },
        "wpn_holycrystal_wand":{ n: "聖晶魔杖", type: "wpn", legend: true, dmgS: 23, dmgL: 21, hit: 13, dmgBonus: 4, spd: 1.0, req: "mage,illusion", safe: 6, p: 500000, gachaWeight: 0, eff: "magicburst", ignHardSkin: true, int: 2, mdmg: 7, magicHit: 2, enDmgExtra: 2, enMagicDmg: 1, enMagicHit: 1, procSkill: "sk_holy_lightning", procRateBase: 1, procRatePerEn: 1, d: "單手魔杖。23/21，INT+2、近傷+4、SP+7、近命中+13、魔法命中+2；發動致命落雷（套用六階×3核心係數，不套舊法師×1.8），每強化原始傷害+1、武器專屬額外傷害+2（合計+3）、SP+1、魔法命中+1、發動率+1%。" },
        "wpn_gaia_rage":       { n: "大地女神的激怒", type: "wpn", isBow: true, ranged: true, w2h: true, legend: true, dmgS: 29, dmgL: 27, hit: 8, dmgBonus: 17, dex: 3, rangedCrit: 1, dr: 2, enDmgExtra: 2, enRangedCrit: 1, spd: 1, req: "elf", safe: 6, p: 500000, gachaWeight: 0, ignHardSkin: true, spellProc: { skn: "大地射擊", dice: [8, 12], ele: "earth", rangedScale: true }, procRateBase: 1, procRatePerEn: 1, d: "妖精專屬雙手弓。29/27，DEX+3、遠傷+17、遠命中+8、遠爆擊+1%、減傷+2；發動大地射擊；每強化原始傷害+1、武器專屬額外傷害+2（合計+3），遠爆擊與魔法發動率+1%。" },
        "wpn_hyperion_despair":{ n: "海柏利昂的絕望", type: "wpn", qigu: true, legend: true, dmgS: 38, dmgL: 38, int: 3, mdmg: 2, magicCrit: 1, mhp: 100, qiguDmgPerEn: 2, enMagicDmg: 1, enMagicCrit: 1, spd: 0.8, req: "illusion", safe: 6, p: 500000, gachaWeight: 0, spellProc: { skn: "黑暗隕石", dice: [8, 12], ele: "none", mrPenPct: 30 }, procRateBase: 1, procRatePerEn: 1, d: "幻術士專屬奇古獸。38/38，INT+3、SP+2、魔爆+1%、HP+100；每強化原始傷害+1、武器專屬額外傷害+2（合計+3）、SP+1、魔爆+1%、黑暗隕石發動率+1%，黑暗隕石魔抗穿透30%。" },
        "wpn_cronos_fear":     { n: "克洛諾斯的恐怖", type: "wpn", w2h: true, chainsword: true, weakExpose: true, legend: true, dmgS: 34, dmgL: 26, hit: 10, dmgBonus: 19, str: 2, meleeCrit: 1, skillHit: 7, enDmgExtra: 2, enMeleeCrit: 1, spd: 0.9, req: "dragon", safe: 6, p: 500000, gachaWeight: 0, ignHardSkin: true, spellProc: { skn: "致命一擊", dice: [8, 12], ele: "none", meleeScale: true }, procRateBase: 1, procRatePerEn: 1, d: "龍騎士專屬雙手鎖鏈劍。34/26，STR+2、近傷+19、近命中+10、近爆擊+1%；發動致命一擊；每強化原始傷害+1、武器專屬額外傷害+2（合計+3），近爆擊與魔法發動率+1%。" },
        "wpn_titan_rage":      { n: "泰坦之怒", type: "wpn", legend: true, animFam: "blunt", dmgS: 37, dmgL: 40, hit: 13, dmgBonus: 18, str: 2, meleeCrit: 3, skillHit: 7, enDmgExtra: 2, enMeleeCrit: 1, spd: 1, req: "warrior", safe: 6, p: 500000, gachaWeight: 0, ignHardSkin: true, spellProc: { skn: "泰坦之怒", dice: [8, 12], ele: "none", meleeScale: true }, procRateBase: 1, procRatePerEn: 1, d: "戰士專屬單手斧。37/40，STR+2、近傷+18、近命中+13、近爆擊+3%；每強化原始傷害+1、武器專屬額外傷害+2（合計+3），近爆擊+1%，武器魔法依STR與近戰傷害增幅。" },
        ...
        "acc_117": { n: "變形控制戒指", type: "acc", slot: "ring", ac: 0, req: "all", safe: 0, p: 150000, gachaWeight: 1, unique: true, d: "嵌著變幻紋路的戒指，讓施術者得以主宰自身形貌的流轉。攜帶在背包即可生效（無需裝備）：使用變形卷軸時可指定變身型態，並可覆蓋套裝綁定的變身。角色達80級後亦可自由選擇變身。" },
...
"wpn_giltas_wand":   { n: "吉爾塔斯魔杖", type: "wpn", w2h: true, legend: true, dmgS: 15, dmgL: 15, hit: 0, dmgBonus: 0, spd: 1.0, req: "mage,illusion", safe: 0, p: 990000, gachaWeight: 0, eff: "magicburst", int: 2, wis: 2, mpR: 15, d: "吉爾塔斯魔力凝成的雙手魔杖，杖端迴盪著異界的低語。魔爆（一般限定）、貫穿、智力+2、精神+2、MP自然恢復量+15；擊殺敵人後，獲得額外魔法點數+20，持續10秒。" },
        ...
        "potion_ancient_heal": { n: "古代體力恢復劑", type: "pot", req: "all", p: 63, c: "text-red-200", d: "古代人使用的體力恢復劑，圍繞著古代的氣息。無喝水延遲。", val: 30, valMin: 20, valMax: 40, noPotionDelay: true, gachaWeight: 0 },
        "potion_ancient_strong": { n: "古代強力體力恢復劑", type: "pot", req: "all", p: 375, c: "text-orange-200", d: "古代人使用的強力體力恢復劑，圍繞著古代的氣息。無喝水延遲。", val: 60, valMin: 50, valMax: 70, noPotionDelay: true, gachaWeight: 0 },
        "potion_ancient_ult": { n: "古代終極體力恢復劑", type: "pot", req: "all", p: 990, c: "text-yellow-100", d: "古代人使用的終極體力恢復劑，圍繞著古代的氣息。無喝水延遲。", val: 100, valMin: 90, valMax: 110, noPotionDelay: true, gachaWeight: 0 },
        ...
        "scroll_magicbarrier": { n: "魔法卷軸(魔法屏障)", type: "scroll", req: "all", p: 1500, c: "text-cyan-300", img: "assets/icons/items/魔法卷軸(魔法屏障)-i2384.jpg?v=20260716-i2384", d: "封存魔法屏障的卷軸，展開後能抵擋一次來襲的技能。", eff: "magicbarrier", gachaWeight: 0 },
        ...
        "scroll_equip_protect": { n: "裝備保護卷軸", type: "misc", p: 500000, c: "text-white", img: "assets/icons/items/裝備保護卷軸.jpg", protectScroll: true, eff: "equip_protect", noUse: true, noSell: true, gachaWeight: 0, d: "在武器或防具裝備視窗中，從『強化』下方的『裝備保護』獨立選項使用，取得一次裝備保護狀態。下一次單次強化不論成功或失敗都會消耗保護次數；失敗時裝備不會消失，但強化值-1（最低維持+0）。頭目低機率掉落；亦可向沉默洞穴可羅蘭斯以席琳結晶×20與500萬金幣製作一般版。" },
        "scroll_equip_protect_b": { n: "祝福的 裝備保護卷軸", type: "misc", p: 1000000, c: "text-yellow-300", img: "assets/icons/items/裝備保護卷軸.jpg", protectScroll: true, eff: "equip_protect", isB: true, noUse: true, noSell: true, gachaWeight: 0, d: "在武器或防具裝備視窗中，從『強化』下方的『裝備保護』獨立選項使用，取得一次祝福裝備保護狀態；限+11以上武器或+9以上防具。下一次單次強化不論成功或失敗都會消耗保護次數；失敗時裝備不會消失，強化值維持不變。可向沉默洞穴可羅蘭斯以一般裝備保護卷軸×10與1000萬金幣製作。" },
        ...
        "new_item_bless_wpn": { n: "賦予武器祝福卷軸", type: "misc", eff: "grant_blessing", p: 0, c: "text-purple-300", blessGrant: "wpn", blessRate: 0.30, noUse: true, noSell: true, gachaWeight: 0, d: "在武器裝備視窗中，從『強化』下方右側的『賦予祝福』獨立選項使用，30% 機率轉化為祝福的武器。失敗只消耗卷軸，武器不消失且保留強化、屬性與其他詞綴；詛咒及已祝福的武器無法使用。可向象牙塔（1~3樓）的碧恩製作。" },
        "new_item_bless_arm": { n: "賦予盔甲祝福卷軸", type: "misc", eff: "grant_blessing", p: 0, c: "text-purple-300", blessGrant: "arm", blessRate: 0.30, noUse: true, noSell: true, gachaWeight: 0, d: "在防具裝備視窗中，從『強化』下方右側的『賦予祝福』獨立選項使用，30% 機率轉化為祝福的防具。失敗只消耗卷軸，防具不消失且保留強化與其他詞綴；詛咒及已祝福的防具無法使用。可向象牙塔（1~3樓）的碧恩製作。" },
        "new_item_bless_acc": { n: "賦予飾品祝福卷軸", type: "misc", eff: "grant_blessing", p: 0, c: "text-purple-300", blessGrant: "acc", blessRate: 0.40, noUse: true, noSell: true, gachaWeight: 0, d: "在飾品裝備視窗中，從『強化』下方右側的『賦予祝福』獨立選項使用，40% 機率轉化為祝福的飾品。失敗只消耗卷軸，飾品不消失且保留強化與其他詞綴；詛咒及已祝福的飾品無法使用。可向象牙塔（1~3樓）的碧恩製作。" },
        ...
        "heart_antaras": { n: "安塔瑞斯之心", type: "etc", p: 1, c: "text-amber-200", img: "assets/icons/items/安塔瑞斯之心.png?v=20260713-dragon-hearts", noUse: true, noSell: true, gachaWeight: 0, d: "地龍安塔瑞斯的心臟。哈爾巴斯之心製作材料。" },
        ...
        "wpn_powerless_baphomet": { n: "失去魔力的巴風特魔杖", type: "wpn", dmgS: 1, dmgL: 1, hit: 0, dmgBonus: 0, spd: 1.0, req: "all", safe: 6, p: 0, gachaWeight: 0, noEnhance: true, d: "曾屬於魔神巴風特的魔杖，如今魔力枯竭、沉默不語。對靈魂之球使用可恢復為巴風特魔杖。（封印狀態無法強化；使用靈魂之球解封後成品為 +0。可販售，售價 0）" },   // noEnhance＝封印狀態固定 +0
        ...
        // ===== ✨ 八職業神話武器（僅能以哈爾巴斯之心強化，最高 +15） =====
        "god_royal_flash": { n: "殷海薩的閃光", type: "wpn", godWeapon: true, noEnhance: true, dmgS: 50, dmgL: 40, hit: 22, dmgBonus: 40, meleeCrit: 7, str: 3, enDmgExtra: 4, enHitEvery2: 1, enMeleeCrit: 2, mythWeaponAmpPerEn: 1, royalAllyDmgPerEn: 0.5, spd: 0.9, req: "royal", safe: 0, p: 1, legend: true, gachaWeight: 0, spellProc: { skn: "殷海薩的憤怒", dice: [10, 18], ele: "none", aoe: true, ignoreMagicPower: true, meleeScale: true, powerMult: 2 }, procRateBase: 10, procRatePerEn: 1, d: "王族神話單手劍。50/40，STR+3、近傷+40、近命中+22、近爆擊+7%；每強化近傷總計+5、命中+1、爆擊+2%，每2階再命中+1。神話武器增幅每階+1%；王者統御每階使傭兵最終傷害+0.5%。PVE發動殷海薩的憤怒。" },
        "god_knight_judgment": { n: "格蘭肯的審判", type: "wpn", godWeapon: true, noEnhance: true, w2h: true, dmgS: 46, dmgL: 60, hit: 18, dmgBonus: 44, meleeCrit: 7, str: 3, enDmgExtra: 4, enHitEvery2: 1, enMeleeCrit: 2, mythWeaponAmpPerEn: 1, statusSuccessPctPerEn: 1, statusSuccessKinds: ["stun"], statusSuccessSkills: ["衝擊之暈"], statusSuccessLabel: "技術成功率", spd: 0.9, req: "knight", safe: 0, p: 1, legend: true, gachaWeight: 0, spellProc: { skn: "格蘭肯的憤怒", dice: [12, 18], ele: "none", aoe: true, ignoreMagicPower: true, meleeScale: true, powerMult: 2 }, procRateBase: 10, procRatePerEn: 1, d: "騎士神話雙手劍。46/60，STR+3、近傷+44、近命中+18、近爆擊+7%；每強化近傷總計+5、命中+1、爆擊+2%，每2階再命中+1。神話武器增幅與衝擊之暈技術成功率每階+1%。PVE發動格蘭肯的憤怒。" },
        "god_elf_obsession": { n: "沙哈的執念", type: "wpn", godWeapon: true, noEnhance: true, isBow: true, ranged: true, w2h: true, dmgS: 37, dmgL: 35, hit: 18, dmgBonus: 39, rangedCrit: 10, dex: 3, wis: 2, enDmgExtra: 4, enHitEvery2: 1, enRangedCrit: 2, mythWeaponAmpPerEn: 1, statusSuccessPctPerEn: 1, statusSuccessLabel: "精靈魔法成功率", spd: 1.0, req: "elf", safe: 0, p: 1, legend: true, gachaWeight: 0, spellProc: { skn: "沙哈的憤怒", dice: [10, 20], ele: "wind", aoe: true, ignoreMagicPower: true, rangedScale: true, powerMult: 2 }, procRateBase: 10, procRatePerEn: 1, d: "妖精神話雙手弓。37/35，DEX+3、WIS+2、遠傷+39、遠命中+18、遠爆擊+10%；每強化遠傷總計+5、命中+1、爆擊+2%，每2階再命中+1。神話武器增幅與精靈魔法成功率每階+1%。" },
        "god_mage_eva": { n: "伊娃的誓約", type: "wpn", godWeapon: true, noEnhance: true, isWand: true, dmgS: 32, dmgL: 32, hit: 22, dmgBonus: 25, mdmg: 20, magicHit: 15, str: 2, wis: 2, int: 2, enDmgExtra: 4, enHitEvery2: 1, enMagicDmg: 2, enMagicHit: 2, enMagicHitEvery2: 1, enMagicDamagePct: 1, mythWeaponAmpPerEn: 1, spd: 1.0, eff: "mp_drain", req: "mage", safe: 0, p: 1, legend: true, gachaWeight: 0, spellProc: { skn: "伊娃的憤怒", dice: [9, 20], ele: "water", aoe: true }, procRateBase: 10, procRatePerEn: 1, d: "法師神話單手杖。32/32，STR/WIS/INT+2、近傷+25、近命中+22、SP+20、魔法命中+15、吸MP；每強化近傷總計+5、SP+2、魔法命中+2，每2階再命中與魔法命中+1。神話武器增幅每階+1%。" },
        "god_dark_dantes": { n: "丹特斯的試煉", type: "wpn", godWeapon: true, noEnhance: true, w2h: true, dmgS: 41, dmgL: 31, hit: 21, dmgBonus: 36, meleeCrit: 7, str: 3, con: 2, wis: 1, enDmgExtra: 4, enHitEvery2: 1, enMeleeCrit: 2, mythWeaponAmpPerEn: 1, statusSuccessPctPerEn: 1, statusSuccessKinds: ["armorbreak"], statusSuccessSkills: ["破壞盔甲"], statusSuccessLabel: "破壞盔甲成功率", eff: "combo", comboRate: 30, spd: 0.9, req: "dark", safe: 0, p: 1, legend: true, gachaWeight: 0, spellProc: { skn: "丹特斯的憤怒", dice: [10, 20], ele: "none", aoe: true, ignoreMagicPower: true, meleeScale: true, powerMult: 2 }, procRateBase: 10, procRatePerEn: 1, d: "黑妖神話雙刀。41/31，STR+3、WIS+1、CON+2、近傷+36、近命中+21、近爆擊+7%；每強化近傷總計+5、命中+1、爆擊+2%，每2階再命中+1。神話武器增幅與破壞盔甲成功率每階+1%。" },
        "god_illusion_theia": { n: "泰亞的混沌", type: "wpn", godWeapon: true, noEnhance: true, qigu: true, dmgS: 44, dmgL: 44, hit: 0, int: 3, wis: 2, magicCrit: 7, mhp: 500, mdmg: 16, qiguDmgPerEn: 2, enMagicDmg: 2, enMagicDmgEvery2: 1, enMagicCrit: 2, mythWeaponAmpPerEn: 1, statusSuccessPctPerEn: 1, statusSuccessLabel: "幻術成功率", spd: 0.8, req: "illusion", safe: 0, p: 1, legend: true, gachaWeight: 0, spellProc: { skn: "泰亞的憤怒", dice: [9, 20], ele: "none", aoe: true }, procRateBase: 10, procRatePerEn: 1, d: "幻術神話奇古獸。44/44，INT+3、WIS+2、SP+16、HP+500、魔爆+7%；每強化原始傷害+1、武器專屬額外傷害+2（合計+3）、SP+2、魔爆+2%，每2階再SP+1。神話武器增幅與幻術成功率每階+1%。PVE發動泰亞的憤怒。" },
        "god_dragon_aurakia": { n: "奧拉奇亞的超越", type: "wpn", godWeapon: true, noEnhance: true, w2h: true, chainsword: true, weakExpose: true, dmgS: 46, dmgL: 40, hit: 19, dmgBonus: 41, meleeCrit: 7, str: 3, enDmgExtra: 4, enHitEvery2: 1, enMeleeCrit: 2, mythWeaponAmpPerEn: 1, statusSuccessPctPerEn: 1, statusSuccessKinds: ["stun", "guardbreak", "terror", "doom"], statusSuccessLabel: "龍語成功率", spd: 0.9, req: "dragon", safe: 0, p: 1, legend: true, gachaWeight: 0, spellProc: { skn: "奧拉奇亞的憤怒", dice: [11, 20], ele: "fire", aoe: true, ignoreMagicPower: true, meleeScale: true, powerMult: 2 }, procRateBase: 10, procRatePerEn: 1, d: "龍騎神話雙手鎖鏈劍。46/40，STR+3、近傷+41、近命中+19、近爆擊+7%；每強化近傷總計+5、命中+1、爆擊+2%，每2階再命中+1。神話武器增幅與龍語成功率每階+1%。" },
        "god_warrior_fear": { n: "格蘭肯的恐怖", type: "wpn", godWeapon: true, noEnhance: true, animFam: "blunt", dmgS: 46, dmgL: 50, hit: 18, dmgBonus: 38, meleeCrit: 7, str: 3, enDmgExtra: 4, enHitEvery2: 1, enMeleeCrit: 2, mythWeaponAmpPerEn: 1, titanReflectPctPerEn: 1, titanBulletErEvery: 3, titanBulletErGain: 1, spd: 0.9, req: "warrior", safe: 0, p: 1, legend: true, gachaWeight: 0, spellProc: { skn: "格蘭肯的恐怖之怒", dice: [12, 18], ele: "none", aoe: true, ignoreMagicPower: true, meleeScale: true, powerMult: 2 }, procRateBase: 10, procRatePerEn: 1, d: "戰士神話單手斧。46/50，STR+3、近傷+38、近命中+18、近爆擊+7%；每強化近傷總計+5、命中+1、爆擊+2%，每2階再命中+1。神話武器增幅每階+1%；泰坦岩石／魔法反射每階+1%，每3階使泰坦子彈ER+1。PVE發動恐怖之怒。" },
        "wpn_qigu_killing_intent": { n: "殺意奇古獸", type: "wpn", qigu: true, dmgS: 35, dmgL: 35, hit: 0, spd: 0.8, int: 1, mdmg: 2, magicCrit: 1, enMagicCritFrom7: 1, enMagicCritMax: 4, spellProc: { skn: "靈魂切割", dice: [5, 10], ele: "none" }, procRateBase: 1, procRatePerEn: 1, req: "illusion", safe: 6, p: 450000, gachaWeight: 1, d: "幻術士專屬奇古獸。35/35，INT+1、SP+2、魔爆+1%；+7起每強化魔爆+1%（最多再+4%），靈魂切割發動率每強化+1%。" },
        ...
        "wpn_chain_exterminator": { n: "殲滅者鎖鏈劍", type: "wpn", w2h: true, chainsword: true, weakExpose: true, dmgS: 27, dmgL: 22, hit: 6, dmgBonus: 5, spd: 0.9, skillHit: 0, skillHitPerEnFrom7: 1, skillHitPerEnMax: 4, spellProc: { skn: "殲滅", dice: [6, 10], ele: "none" }, procRateBase: 10, procRatePerEn: 0, procUnlockEn: 10, req: "dragon", safe: 6, p: 360000, gachaWeight: 1, d: "龍騎士專屬雙手鎖鏈劍。近距離傷害+5、命中+6；+7起每強化+1秘技命中+1（最多+4），+10起以固定10%機率發動殲滅。" },
    ...
    towns: {
        ...
        "town_sherine": {   // 🔮 新安全區：席琳神殿
            ...
            npcs: [
                ...
                { id: "npc_halphas_smith", n: "赫爾", title: "神話武器製作", type: "craft", d: "侍奉神龍的鐵匠赫爾。融合四大龍心製作哈爾巴斯之心，並以祝福的 +15 傳說武器、哈爾巴斯之心與金幣鍛造八職業神話武器，也能進行神話武器專用強化。" }
            ]
        },
...
// 官方版指引橫幅（中性·無指控）：僅在非官方網域顯示；每次載入顯示 10 秒後淡出。
var _origNoticeExpired = false;
function _origEnforce() {
  try {
    if (_origAuthorizedHost()) return;
    if (_origNoticeExpired || !document.body || document.getElementById('_orig_pbar')) return;

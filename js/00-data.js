...
const DB = {
        ...
        "relic_whiteant_shell":     { n: "白螞蛋殼",         type: "arm", slot: "shield", relic: true, noEnhance: true, ac: 0, onDmgHeal: "sk_heal1", req: "royal,knight,elf,mage,dark,dragon,illusion", p: 10000, gachaWeight: 0, d: "【遺物】白螞蟻群未孵化的堅殼，受創時湧出療癒之力。<br>受到傷害時，對自身施展不消耗 MP 的初級治癒術（每 5 秒最多 1 次）。" },
	...
	skills: {
        ...
        "sk_relic_silence": { n: "沉默", type: "atk", status: { kind: "magicseal", dur: 8, force: true } },   // 🏺 遺物「七彩鸚鵡喙」攻擊命中觸發用（procStatusSkill·非可學技能）；怪物用 magicseal(魔法封印) 實現沉默·js/03:367 施法閘讀 st.magicseal

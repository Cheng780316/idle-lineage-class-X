...
const DB = {
        ...
        "scroll_equip_protect": { n: "裝備保護卷軸", type: "misc", p: 500000, c: "text-white", img: "assets/icons/items/裝備保護卷軸.jpg", protectScroll: true, eff: "equip_protect", noUse: true, noSell: true, gachaWeight: 0, d: "在武器或防具的『強化』選項中使用，取得一次裝備保護狀態。下一次單次強化不論成功或失敗都會消耗保護次數；失敗時裝備不會消失，但強化值-1（最低維持+0）。頭目低機率掉落；亦可向沉默洞穴可羅蘭斯以席琳結晶×20與500萬金幣製作一般版。" },
        "scroll_equip_protect_b": { n: "祝福的 裝備保護卷軸", type: "misc", p: 1000000, c: "text-yellow-300", img: "assets/icons/items/裝備保護卷軸.jpg", protectScroll: true, eff: "equip_protect", isB: true, noUse: true, noSell: true, gachaWeight: 0, d: "在武器或防具的『強化』選項中使用，取得一次祝福裝備保護狀態；限+11以上武器或+9以上防具。下一次單次強化不論成功或失敗都會消耗保護次數；失敗時裝備不會消失，強化值維持不變。可向沉默洞穴可羅蘭斯以一般裝備保護卷軸×10與1000萬金幣製作。" },
        ...
        "new_item_bless_wpn": { n: "賦予武器祝福卷軸", type: "misc", eff: "grant_blessing", p: 0, c: "text-purple-300", blessGrant: "wpn", blessRate: 0.30, noUse: true, noSell: true, gachaWeight: 0, d: "在武器的『強化』選項中使用，30% 機率轉化為祝福的武器。失敗只消耗卷軸，武器不消失且保留強化、屬性與其他詞綴；詛咒及已祝福的武器無法使用。可向象牙塔（1~3樓）的碧恩製作。" },
        "new_item_bless_arm": { n: "賦予盔甲祝福卷軸", type: "misc", eff: "grant_blessing", p: 0, c: "text-purple-300", blessGrant: "arm", blessRate: 0.30, noUse: true, noSell: true, gachaWeight: 0, d: "在防具的『強化』選項中使用，30% 機率轉化為祝福的防具。失敗只消耗卷軸，防具不消失且保留強化與其他詞綴；詛咒及已祝福的防具無法使用。可向象牙塔（1~3樓）的碧恩製作。" },
        "new_item_bless_acc": { n: "賦予飾品祝福卷軸", type: "misc", eff: "grant_blessing", p: 0, c: "text-purple-300", blessGrant: "acc", blessRate: 0.40, noUse: true, noSell: true, gachaWeight: 0, d: "在飾品的『強化』選項中使用，40% 機率轉化為祝福的飾品。失敗只消耗卷軸，飾品不消失且保留強化與其他詞綴；詛咒及已祝福的飾品無法使用。可向象牙塔（1~3樓）的碧恩製作。" },

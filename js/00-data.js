...
const DB = {
        ...
        "scroll_mystic_enchant": { n: "裝備魔力附魔卷軸", type: "misc", eff: "mystic_enchant", p: 0, c: "text-fuchsia-300", gachaWeight: 0, d: "對一件武器、防具或飾品附加隨機稀有度與能力；武器可獲得攻擊、吸血、吸魔能力，防具與飾品可獲得防禦、回血、回魔能力。" },
        "scroll_enhance_protect": { n: "武器裝備強化保護卷軸", type: "misc", eff: "enhance_protect", p: 0, c: "text-cyan-300", gachaWeight: 0, d: "賦予一件高強化裝備 1 次爆裝保護。武器需 +10 以上；防具需 +8 以上。強化失敗原本會消失時，改為消耗保護且裝備保留。" },
    ...
    towns: {
        ...
        "town_sherine": {   // 🔮 新安全區：席琳神殿
            ...
            npcs: [
                ...
                ,{ id: "npc_sherine_enchanter", n: "米斯特", title: "附魔卷軸兌換", type: "quest", d: "席琳神殿的附魔祭司。以強化卷軸、席琳結晶或天幣兌換裝備魔力附魔卷軸與強化保護卷軸。" }
            ]
        },

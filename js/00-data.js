...
const DB = {
        ...
        "wpn_emperor_blade":   { n: "真．冥皇執行劍", type: "wpn", w2h: true, legend: true, dmgS: 35, dmgL: 44, hit: 12, dmgBonus: 20, spd: 1, req: "royal,knight,dragon", safe: 6, p: 500000, gachaWeight: 0, eff: "cleave", ignHardSkin: true, str: 2, skillHit: 7, stunHitBonus: 35, meleeCrit: 1, d: "雙手劍。35/44，STR+2、近傷+20、近命中+12、技術命中+7、近距離爆擊+1%；王族、騎士、龍騎士可用，不會損壞。" },
        "wpn_windblade_dagger":{ n: "風刃短劍", type: "wpn", legend: true, dmgS: 28, dmgL: 19, hit: 13, dmgBonus: 10, spd: 0.6, req: "royal,elf", safe: 6, p: 500000, gachaWeight: 0, ignHardSkin: true, mhp: 100, vampPct: 0.1, d: "單手短劍。28/19，近傷+10、近命中+13、HP+100、攻擊時吸取HP；王族、妖精可用，不會損壞。" },
        ...
        "wpn_beastking_claw":  { n: "獸王鋼爪", type: "wpn", w2h: true, legend: true, dmgS: 25, dmgL: 20, hit: 0, dmgBonus: 10, spd: 0.9, req: "dark", safe: 6, p: 500000, gachaWeight: 0, eff: "combo", comboRate: 33, ignHardSkin: true, dex: 2, d: "黑暗妖精專屬鋼爪。25/20，DEX+2、近傷+10；保留鋼爪爆擊特性，不會損壞。" },

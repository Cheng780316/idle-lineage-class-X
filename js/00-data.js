...
const DB = {
        ...
        "wpn_emperor_blade":   { n: "真．冥皇執行劍", type: "wpn", w2h: true, legend: true, dmgS: 35, dmgL: 44, hit: 12, dmgBonus: 20, spd: 1, req: "royal,knight,dragon", safe: 0, p: 500000, gachaWeight: 0, eff: "cleave", ignHardSkin: true, str: 2, skillHit: 7, stunHitBonus: 35, meleeCrit: 1, d: "雙手劍。35/44，STR+2、近傷+20、近命中+12、技術命中+7、近距離爆擊+1%；王族、騎士、龍騎士可用，不會損壞。" },
        "wpn_windblade_dagger":{ n: "風刃短劍", type: "wpn", legend: true, dmgS: 28, dmgL: 19, hit: 13, dmgBonus: 10, spd: 0.6, req: "royal,elf", safe: 0, p: 500000, gachaWeight: 0, ignHardSkin: true, mhp: 100, vampPct: 0.1, d: "單手短劍。28/19，近傷+10、近命中+13、HP+100、攻擊時吸取HP；王族、妖精可用，不會損壞。" },
        "wpn_redshadow_dual":  { n: "紅影雙刀", type: "wpn", w2h: true, legend: true, dmgS: 32, dmgL: 22, hit: 10, dmgBonus: 12, spd: 0.8, req: "dark", safe: 0, p: 500000, gachaWeight: 0, eff: "combo", comboRate: 25, ignHardSkin: true, str: 1, spiritHit: 5, enDmgExtra: 1, skillHitPerEn: 1, d: "黑暗妖精專屬雙刀。32/22，STR+1、近傷+12、近命中+10、精靈命中+5；每強化+1總傷害+2、破壞命中+1，不會損壞。" },
        "wpn_beastking_claw":  { n: "獸王鋼爪", type: "wpn", w2h: true, legend: true, dmgS: 25, dmgL: 20, hit: 0, dmgBonus: 10, spd: 0.9, req: "dark", safe: 0, p: 500000, gachaWeight: 0, eff: "combo", comboRate: 33, ignHardSkin: true, dex: 2, d: "黑暗妖精專屬鋼爪。25/20，DEX+2、近傷+10；保留鋼爪爆擊特性，不會損壞。" },
        "wpn_holycrystal_wand":{ n: "聖晶魔杖", type: "wpn", legend: true, dmgS: 23, dmgL: 21, hit: 13, dmgBonus: 4, spd: 1.0, req: "mage,illusion", safe: 0, p: 500000, gachaWeight: 0, eff: "magicburst", ignHardSkin: true, int: 2, mdmg: 7, magicHit: 2, enDmgExtra: 1, enMagicDmg: 1, enMagicHit: 1, procSkill: "sk_holy_lightning", procRateBase: 1, procRatePerEn: 1, d: "單手魔杖。23/21，INT+2、近傷+4、SP+7、近命中+13、魔法命中+2；發動致命落雷，每強化+1總傷害+2、SP+1、魔法命中+1、發動率+1%。" },
        "wpn_gaia_rage":       { n: "大地女神的激怒", type: "wpn", isBow: true, ranged: true, w2h: true, legend: true, dmgS: 29, dmgL: 27, hit: 8, dmgBonus: 17, dex: 3, rangedCrit: 1, dr: 2, enDmgExtra: 1, enRangedCrit: 1, spd: 1, req: "elf", safe: 0, p: 500000, gachaWeight: 0, ignHardSkin: true, d: "妖精專屬雙手弓。29/27，DEX+3、遠傷+17、遠命中+8、遠爆擊+1%、減傷+2；每強化+1總傷害+2、遠爆擊+1%。" },
        "wpn_hyperion_despair":{ n: "海柏利昂的絕望", type: "wpn", qigu: true, legend: true, dmgS: 38, dmgL: 38, int: 3, mdmg: 2, magicCrit: 1, mhp: 100, qiguDmgPerEn: 2, enMagicDmg: 1, enMagicCrit: 1, spd: 0.8, req: "illusion", safe: 0, p: 500000, gachaWeight: 0, spellProc: { skn: "黑暗隕石", dice: [8, 12], ele: "none" }, procRateBase: 1, procRatePerEn: 1, d: "幻術士專屬奇古獸。38/38，INT+3、SP+2、魔爆+1%、HP+100；每強化+1傷害+2、SP+1、魔爆+1%、黑暗隕石發動率+1%。" },
        "wpn_cronos_fear":     { n: "克洛諾斯的恐怖", type: "wpn", w2h: true, chainsword: true, weakExpose: true, legend: true, dmgS: 34, dmgL: 26, hit: 10, dmgBonus: 19, str: 2, meleeCrit: 1, skillHit: 7, enDmgExtra: 1, enMeleeCrit: 1, spd: 0.9, req: "dragon", safe: 0, p: 500000, gachaWeight: 0, ignHardSkin: true, d: "龍騎士專屬雙手鎖鏈劍。34/26，STR+2、近傷+19、近命中+10、近爆擊+1%；每強化+1總傷害+2、近爆擊+1%。" },
        "wpn_titan_rage":      { n: "泰坦之怒", type: "wpn", legend: true, dmgS: 37, dmgL: 40, hit: 13, dmgBonus: 18, str: 2, meleeCrit: 3, skillHit: 7, enDmgExtra: 1, enMeleeCrit: 1, spd: 1, req: "warrior", safe: 0, p: 500000, gachaWeight: 0, ignHardSkin: true, spellProc: { skn: "泰坦之怒", dice: [8, 12], ele: "none" }, procRateBase: 1, procRatePerEn: 1, d: "戰士專屬單手斧。37/40，STR+2、近傷+18、近命中+13、近爆擊+3%；每強化+1總傷害+2、近爆擊+1%。" },
        ...
        "scroll_equip_protect": { n: "裝備保護卷軸", type: "misc", p: 500000, c: "text-white", img: "assets/icons/items/裝備保護卷軸.jpg", protectScroll: true, noUse: true, noSell: true, gachaWeight: 0, d: "頭目低機率掉落。可用於武器、防具與飾品；成功時強化值+1，失敗時裝備不會消失，但強化值-1（最低降至-1）。" },
        "scroll_equip_protect_b": { n: "祝福裝備保護卷軸", type: "misc", p: 1000000, c: "text-yellow-300", img: "assets/icons/items/裝備保護卷軸.jpg", protectScroll: true, isB: true, noUse: true, noSell: true, gachaWeight: 0, d: "沉默洞穴可羅蘭斯製作。帶有黃色祝福光芒；成功時強化值+1，失敗時裝備不會消失，強化值也維持不變。" },
        ...
        "heart_antaras": { n: "安塔瑞斯之心", type: "etc", p: 1, c: "text-amber-200", noUse: true, noSell: true, gachaWeight: 0, d: "地龍安塔瑞斯的心臟。哈爾巴斯之心製作材料。" },
        "heart_valakas": { n: "巴拉卡斯之心", type: "etc", p: 1, c: "text-red-300", noUse: true, noSell: true, gachaWeight: 0, d: "火龍巴拉卡斯的心臟。哈爾巴斯之心製作材料。" },
        "heart_fafurion": { n: "法利昂之心", type: "etc", p: 1, c: "text-blue-300", noUse: true, noSell: true, gachaWeight: 0, d: "水龍法利昂的心臟。哈爾巴斯之心製作材料。" },
        "heart_lindvior": { n: "林德拜爾之心", type: "etc", p: 1, c: "text-emerald-300", noUse: true, noSell: true, gachaWeight: 0, d: "風龍林德拜爾的心臟。哈爾巴斯之心製作材料。" },

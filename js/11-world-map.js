    ...
    div.innerHTML = `
        <div class="flex flex-col gap-3 p-1">
            ...
            <div class="bg-slate-900/70 border ${mad ? 'border-rose-600' : 'border-slate-700'} rounded p-3 text-sm leading-relaxed">
                ...
                <div class="text-slate-200 text-xs">極致試煉。怪物 HP×5、MR×3、命中×2、傷害×3、額外減傷＝等級÷3，AC 額外降低（一般怪10／頭目20）、經驗/金錢×10，掉落與詞綴×5；頭目與一般怪套用相同 HP、MR、減傷倍率，<span class="c-sherine font-bold">套裝效果與席琳結晶掉率為一般席琳的 3 倍</span>。</div>
            </div>
...
const NPC_SPR_FIXED = {
    ...
    npc_dantes_lord: '5454', npc_atelier: '1768', npc_halphas_smith: '1768',   // 🌑 長老會議廳亞提利歐／席琳神殿赫爾＝矮人鐵匠外型 1768
...
const TOWN_NPC_SPOTS = {
    ...
    // 席琳神殿(圓形劇場遺跡)：席琳=劇場圓台中央(祈禱)｜伊奧=十字路星紋｜菈克希絲=左上拱門前｜赫爾=右下開闊石板；避開四處水池
    town_sherine: [[67, 48], [42, 64], [16, 33], [57, 72]],

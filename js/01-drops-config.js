    const MOB_DROPS = {
        ...
        '邪惡的鐮刀死神': [['scroll_acc',0.1],['wpn_katana',30], ['wpn_siruge',10], ['wpn_dual_abyss',0.1], ['wpn_claw_abyss',0.1], ['wpn_xbow_abyss',0.1], ['wpn_qigu_killing_intent',0.1], ['wpn_chain_exterminator',0.1], ['clk_silver_light',2], ['arm_88',0.5], ['arm_59',3], ['arm_99',3], ['acc_117',1], ['acc_summon_ctrl',0.5], ['rng_water',5], ['rng_earth',5], ['rng_wind',5], ['rng_fire',5], ['acc_128',10], ['acc_130',2], ['glv_reaper',10], ['scroll_weapon',100], ['scroll_armor',100], ['bk_summon',5], ['bk_resurrection',5], ['bk_disintegrate',1], ['bk_create_magic_weapon',1], ['item_pride_sealed_11',1], ['item_pride_sealed_21',1], ['item_pride_sealed_31',1], ['item_pride_sealed_41',1], ['item_pride_sealed_51',1], ['item_pride_sealed_61',1], ['item_pride_sealed_71',1], ['item_pride_sealed_81',1], ['item_pride_sealed_91',1]],
        // ===== 🏝️ 遺忘之島：怪物掉落 =====
        '遺忘之島鱷魚': [['arm_95',0.1]],
...
const SAVE_DEFAULTS = {
    ...
    magicShieldCd: 0, reviveScrollCd: 0, equipProtect: null, lastMapByCat: {}, lastBattleMap: null, tracking: null, ismaelAccUsed: false, sherineWorld: false, sherineMad: false, classicMode: false, traditionalMode: false,
    ...
    siege:   { active:false, city:'kent', occupiedCity:null, victoryCity:null, gateKilled:false, towerKilled:false, endTime:0, kills:0, result:null,
               lastSiegeEndedAt:0, nextDeclareAt:0, nextDefenseAt:0, dailyResetV:0,
...
//      HP×[3/5]、AC 額外降低[一般怪10/頭目20]、MR×[1.5/3]、命中×[1.5/2]、額外減傷 +floor(等級/3)、
...
let player = {
    ...
    base: { str:0, dex:0, con:0, int:0, wis:0, cha:8 }, bonus: 0, alloc: { str:0, dex:0, con:0, int:0, wis:0, cha:0 }, panacea: { str:0, dex:0, con:0, int:0, wis:0, cha:0 }, panaceaUsed: 0, junkPrefs: {}, bloodPledge: null, magicShieldCd: 0, equipProtect: null, lastMapByCat: {}, tracking: null, ismaelAccUsed: false, sherineWorld: false, masteryQuest: null, mastery: null, masteryChangeCnt: 0, siege: { active:false, city:'kent', occupiedCity:null, victoryCity:null, gateKilled:false, towerKilled:false, endTime:0, kills:0, result:null, lastSiegeEndedAt:0, nextDeclareAt:0, nextDefenseAt:0, dailyResetV:1, cooldownUntil:0, rewardPending:false, victoryUntil:0, accCdUntil:0 },

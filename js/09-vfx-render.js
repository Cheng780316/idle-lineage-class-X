...
const SPELL_FX = {
    '精神共鳴': { dir:'黑闇之影', prefix:'2175-0', n:8, fps:14, blend:'screen', h:1, ax:0.50, ay:0.55 },
    // 可羅蘭斯傳說武器魔法：依 2023 傳說／神話武器改版頁的「+6 以上」外觀，
    // 以現有天堂原版透明逐幀素材重組；不再區分 +0~+5，所有強化值均直接播放強化版。
    '風之力': { dir:'極道落雷', prefix:'10-0', n:6, fps:16, blend:'screen', h:1.7, ax:0.50, ay:0.98,
                filter:'hue-rotate(242deg) saturate(2.15) brightness(1.32)', followups:[{ skn:'傳說風環', delay:80 }] },
    '傳說風環': { dir:'龍捲風', prefix:'758-0', n:20, fps:18, blend:'screen', h:0.9, ax:0.50, ay:0.62,
                  filter:'hue-rotate(238deg) saturate(1.75) brightness(1.12)', opacity:0.88 },
    '審判衝擊': { dir:'極道落雷', prefix:'10-0', n:6, fps:17, blend:'screen', h:1.9, ax:0.50, ay:0.98,
                  filter:'hue-rotate(172deg) saturate(1.5) brightness(1.55)', followups:[{ skn:'審判地火', delay:50 }] },
    '審判地火': { dir:'烈炎術', prefix:'1811-0', n:19, fps:18, blend:'screen', h:0.95, ax:0.50, ay:0.58,
                  filter:'saturate(1.45) brightness(1.18)', opacity:0.82 },
    '大地射擊': { dir:'風刃', prefix:'1799-0', n:5, fps:18, blend:'screen', h:0.92, ax:0.50, ay:0.55,
                  filter:'hue-rotate(315deg) saturate(1.85) brightness(1.55)', followups:[{ skn:'大地射擊火花', delay:45 }] },
    '大地射擊火花': { dir:'會心一擊', prefix:'2952-0', n:16, fps:20, blend:'screen', h:0.72, ax:0.50, ay:0.55,
                      filter:'hue-rotate(62deg) saturate(1.9) brightness(1.25)', opacity:0.9 },
    '迅捷斬擊': { dir:'黑闇之影', prefix:'2175-0', n:8, fps:18, blend:'screen', h:0.92, ax:0.50, ay:0.55,
                  filter:'hue-rotate(276deg) saturate(2) brightness(1.18)', followups:[{ skn:'迅捷雙刃', delay:35 }] },
    '迅捷雙刃': { dir:'風刃', prefix:'1799-0', n:5, fps:20, blend:'screen', h:0.88, ax:0.50, ay:0.55,
                  filter:'hue-rotate(258deg) saturate(2.2) brightness(1.65)' },
    '獸王裂擊': { dir:'黑闇之影', prefix:'1803-0', n:9, fps:18, blend:'screen', h:1, ax:0.50, ay:0.55,
                  filter:'hue-rotate(300deg) saturate(1.9) brightness(1.05)', followups:[{ skn:'獸王爪痕', delay:45 }] },
    '獸王爪痕': { dir:'風刃', prefix:'1799-0', n:5, fps:21, blend:'screen', h:1.02, ax:0.50, ay:0.55,
                  filter:'hue-rotate(286deg) saturate(2.25) brightness(1.48)' },
    '致命落雷': { dir:'極道落雷', prefix:'10-0', n:6, fps:16, blend:'screen', h:1.75, ax:0.50, ay:0.98,
                  filter:'hue-rotate(190deg) saturate(1.35) brightness(1.42)' },
    '致命一擊': { dir:'黑闇之影', prefix:'2175-0', n:8, fps:18, blend:'screen', h:1.05, ax:0.50, ay:0.55,
                  filter:'hue-rotate(228deg) saturate(2.15) brightness(1.2)', followups:[{ skn:'致命弧光', delay:65 }] },
    '致命弧光': { dir:'風刃', prefix:'1799-0', n:5, fps:18, blend:'screen', h:1.12, ax:0.50, ay:0.55,
                  filter:'hue-rotate(210deg) saturate(2) brightness(1.65)' },
    '黑暗隕石': { dir:'火風暴', prefix:'1819-0', n:14, fps:18, blend:'screen', h:1.25, ax:0.50, ay:0.58,
                  filter:'hue-rotate(238deg) saturate(2.4) brightness(0.92)', followups:[{ skn:'黑暗隕石爆發', delay:135 }] },
    '黑暗隕石爆發': { dir:'黑闇之影', prefix:'2175-0', n:8, fps:18, blend:'screen', h:1.12, ax:0.50, ay:0.55,
                      filter:'hue-rotate(245deg) saturate(2.2) brightness(1.22)' },
    '泰坦之怒': { dir:'風刃', prefix:'1799-0', n:5, fps:20, blend:'screen', h:1.05, ax:0.50, ay:0.55,
...
const GOD_WEAPON_ANIM_FX = {
    '殷海薩的憤怒':     { src:'assets/effects/god-weapons/ainshasad.webp?v=20260713-24f',         h:1.82, anchorY:0.69, duration:1560 },
    '格蘭肯的憤怒':     { src:'assets/effects/god-weapons/grankain_judgment.webp?v=20260713-24f', h:1.74, anchorY:0.66, duration:1560 },
    '沙哈的憤怒':       { src:'assets/effects/god-weapons/sayha.webp?v=20260713-24f',             h:1.78, anchorY:0.67, duration:1560 },
    '伊娃的憤怒':       { src:'assets/effects/god-weapons/eva.webp?v=20260713-24f',               h:1.76, anchorY:0.68, duration:1560 },
    '丹特斯的憤怒':     { src:'assets/effects/god-weapons/dantes.webp?v=20260713-24f',            h:1.72, anchorY:0.56, duration:1560 },
    '泰亞的憤怒':       { src:'assets/effects/god-weapons/theia.webp?v=20260713-24f',             h:1.78, anchorY:0.68, duration:1560 },
    '奧拉奇亞的憤怒':   { src:'assets/effects/god-weapons/aurakia.webp?v=20260713-24f',           h:1.94, anchorY:0.72, duration:1560 },
    '格蘭肯的恐怖之怒': { src:'assets/effects/god-weapons/grankain_fear.webp?v=20260713-24f',     h:1.84, anchorY:0.63, duration:1560 }
};
...
const LEGEND_WEAPON_ANIM_FX = {
    ...
    '大地射擊':   { src:'assets/effects/legend-plus6/gaia-rage.webp?v=20260713-16f',          h:1.40, anchorY:0.55, duration:1280 },
    '致命落雷':   { src:'assets/effects/legend-plus6/holycrystal-wand.webp?v=20260713-16f',  h:1.75, anchorY:0.70, duration:1280 },
    '迅捷斬擊':   { src:'assets/effects/legend-plus6/redshadow-dual.webp?v=20260713-16f',    h:1.30, anchorY:0.55, duration:1280 },
    '黑暗隕石':   { src:'assets/effects/legend-plus6/hyperion-despair.webp?v=20260713-16f', h:1.55, anchorY:0.58, duration:1280 },
    '致命一擊':   { src:'assets/effects/legend-plus6/cronos-fear.webp?v=20260713-16f',       h:1.45, anchorY:0.58, duration:1280 },
    '泰坦之怒':   { src:'assets/effects/legend-plus6/titan-rage.webp?v=20260713-16f',        h:1.35, anchorY:0.55, duration:1280 }
};
...
function playQiguAttackSprite(actor) {
    try {
        ...
        el.style.position = 'fixed'; el.style.pointerEvents = 'none';
        el.style.width = w + 'px'; el.style.height = h + 'px';
        el.style.left = (r.left + r.width * 0.5 - w * (102 / 300)) + 'px';
        el.style.top = (r.bottom - h * (236 / 250)) + 'px';
...
function playTripleCastSprite(actor) {
    try {
        ...
        el.style.position = 'fixed'; el.style.pointerEvents = 'none';
        el.style.width = w + 'px'; el.style.height = h + 'px';
        el.style.left = (r.left + r.width * 0.5 - w * (100 / 205)) + 'px';
        el.style.top = (r.bottom - h * (170 / 179)) + 'px';
        el.style.objectFit = 'contain'; el.style.imageRendering = 'pixelated';
        el.style.zIndex = '31';
        layer.appendChild(el);
        st.el.style.opacity = '0';

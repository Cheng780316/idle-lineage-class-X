...
const SPELL_FX = {
    ...
    // 可羅蘭斯傳說武器魔法：以天堂原版逐幀素材重新組合，補上武器發動時的專屬命中特效。
    '致命落雷': { dir:'極道落雷', prefix:'10-0', n:6, fps:16, blend:'screen', h:1.75, ax:0.50, ay:0.98,
                  filter:'saturate(1.25) brightness(1.12)' },
    '黑暗隕石': { dir:'流星雨', prefix:'762-0', n:20, fps:17, blend:'screen', h:1.65, ax:0.50, ay:0.88,
                  filter:'hue-rotate(205deg) saturate(1.8) brightness(0.78)', followups:[{ skn:'黑闇之影', delay:430 }] },
    '泰坦之怒': { dir:'震裂術', prefix:'1812-0', n:16, fps:16, blend:'screen', h:1.15, ax:0.50, ay:0.62,
                  filter:'hue-rotate(330deg) saturate(1.35) brightness(1.05)', followups:[{ skn:'地裂術', delay:220 }] },
